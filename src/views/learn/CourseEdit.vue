...
<template>
  <div v-if="isOwner">
    ...
    <form>
      ...
      <div class="form-floating mb-3">
        <input placeholder="course image" v-model="courseStore.course.image" type="text" class="form-control"
          id="courseImage" aria-describedby="courseImageHelp">
        <label for="courseImage">Image</label>
        <div id="courseImageHelp" class="form-text">The course image filename.</div>
      </div>
      <div class="form-floating mb-3">
        <input placeholder="short description" v-model="courseStore.course.shortDesc" type="text" class="form-control"
          id="courseShortDesc" aria-describedby="courseShortDescHelp">
        <label for="courseShortDesc">Short Description</label>
        <div id="courseShortDescHelp" class="form-text">The course name needs a short description for listing cards,
          social
          media, and search engines.</div>
      </div>
